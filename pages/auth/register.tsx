    ...
    >
      ...
      <div className="w-full border rounded-lg shadow-lg border-gray-300 mt-5 flex flex-col p-7">
        ...
        <input type="password" placeholder="Confirm password..." maxLength={50}
          className={`border-b-2 py-3 px-2  focus:outline-none ${errors.confirmPassword && errors.confirmPassword.length > 0 ? "border-b-red-400" : ""}`} name="confirmPassword" onChange={handleInputChange}
        />
